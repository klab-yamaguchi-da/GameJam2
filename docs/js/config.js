...
const LEVELS = [
    ...
    },
    {
        ...
        platforms: [
            ...
            // 3層目: 幅30の複数プラットフォーム
            { x: 100, y: 380, width: 30 },
            { x: 250, y: 380, width: 30 },
            { x: 400, y: 380, width: 30 },
            { x: 550, y: 380, width: 30 },
            { x: 700, y: 380, width: 30 },
        ...
        ladders: [
            ...
            // 3層目の各プラットフォームの下に長さ40のはしご
            { x: 100, y: 380, height: 40 },
            { x: 250, y: 380, height: 40 },
            { x: 400, y: 380, height: 40 },
            { x: 550, y: 380, height: 40 },
            { x: 700, y: 380, height: 40 },
